(function() {
	...
	vm.facetParam1Ex2 = '{"slider":{"value":{"min":1800,"max":1900},"constraint":"?id <http://xmlns.com/foaf/0.1/focus>/^<http://www.cidoc-crm.org/cidoc-crm/P98_brought_into_life>/<http://ldf.fi/nbf/time>/<http://vocab.getty.edu/ontology#estStart> ?slider_89 . FILTER (1800<=year(?slider_89) && year(?slider_89)<=1900) "},"category":{"value":"\"kirjallisuus\"@fi","constraint":" ?id <http://xmlns.com/foaf/0.1/focus>/<http://ldf.fi/nbf/has_category>/<http://www.w3.org/2004/02/skos/core#prefLabel> \"kirjallisuus\"@fi . "}}';
        ...
        vm.facetParam2Ex2 = '{"slider":{"value":{"min":1800,"max":1900},"constraint":"?id <http://xmlns.com/foaf/0.1/focus>/^<http://www.cidoc-crm.org/cidoc-crm/P98_brought_into_life>/<http://ldf.fi/nbf/time>/<http://vocab.getty.edu/ontology#estStart> ?slider_76 . FILTER (1800<=year(?slider_76) && year(?slider_76)<=1900) "},"category":{"value":"\"kuvataiteet, valokuvaus\"@fi","constraint":" ?id <http://xmlns.com/foaf/0.1/focus>/<http://ldf.fi/nbf/has_category>/<http://www.w3.org/2004/02/skos/core#prefLabel> \"kuvataiteet, valokuvaus\"@fi . "}}';
